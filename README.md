 ...
 * `pgn FILE [VERBOSITY]`: Save games to `FILE`, in PGN format. `VERBOSITY` is optional (default value 1): 0 for no comments, 1 for `{score/deph}` comments, or 2 for `{score/depth time}` comments.
